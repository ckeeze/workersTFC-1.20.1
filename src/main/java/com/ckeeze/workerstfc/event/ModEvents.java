...
public class ModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event){
        ...
        if(event.getType() == ModVillagers.POTTER.get()) {
            ...
            trades.get(2).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.COIN.get(), 3),
            ...
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.COIN.get(), 6),
            ...
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.COIN.get(), 12),
            ...
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.COIN.get(), 16),
        ...
        if(event.getType() == ModVillagers.JEWELER.get()) {
            ...
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    new ItemStack(ModItems.COIN.get(), 7),
                    8, 1, 0.02f));
            ...
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.COIN.get(), 32),
